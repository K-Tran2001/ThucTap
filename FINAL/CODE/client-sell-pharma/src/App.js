...
import CategoryDrugScreen from "./screens/CategoryDrugScreen";
  ...
  return (
    <Router>
      <Switch>
        ...
        <Route path="/:id/cate-drug" component={CategoryDrugScreen} exact />
        <Route path="/:id/category" component={CategoryDrugScreen} exact />
