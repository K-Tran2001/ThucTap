...
const ToastObjects = {
  ...
  export const loginGoogle = (response) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.post(`/api/customers/google_login`, formatTokenId, config);
      if( data ){
        toast.success(`Hi ${data.name}, welcome to shop`, ToastObjects);
  ...
  export const register = ({name, email, phone, password}) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.post(`/api/customers`, { name, email, phone, password }, config);
      console.log({data});
      if(data){
  ...
  export const confirmRegister = (token) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.post(`/api/customers/active`, formatToken , config);
  ...
  export const forgotPass = (email) => async (dispatch) => {
    try {
      if(email===''){
        ...
        const { data } = await axios.post(`/api/customers/forgotpass`, formatEmail, config);
  ...
  export const confirmForgot = (dataReset) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.post(`/api/customers/confirm/password`, dataReset , config);
  ...
  export const getUserDetails = () => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.get(`/api/customers/profile`, config);
